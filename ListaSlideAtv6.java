...
class Main {
  public static void main(String[] args) {
    ...
    double massa = Double.parseDouble(JOptionPane.showInputDialog("Digite o peso em KG: "));
    double altura = Double.parseDouble(JOptionPane.showInputDialog("Digite a altura em M: "));
